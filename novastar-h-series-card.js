var ht=globalThis,ut=ht.ShadowRoot&&(ht.ShadyCSS===void 0||ht.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,xt=Symbol(),Tt=new WeakMap,J=class{constructor(t,e,r){if(this._$cssResult$=!0,r!==xt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(ut&&t===void 0){let r=e!==void 0&&e.length===1;r&&(t=Tt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),r&&Tt.set(e,t))}return t}toString(){return this.cssText}},Dt=c=>new J(typeof c=="string"?c:c+"",void 0,xt),pt=(c,...t)=>{let e=c.length===1?c[0]:t.reduce((r,s,i)=>r+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+c[i+1],c[0]);return new J(e,c,xt)},Ut=(c,t)=>{if(ut)c.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let r=document.createElement("style"),s=ht.litNonce;s!==void 0&&r.setAttribute("nonce",s),r.textContent=e.cssText,c.appendChild(r)}},wt=ut?c=>c:c=>c instanceof CSSStyleSheet?(t=>{let e="";for(let r of t.cssRules)e+=r.cssText;return Dt(e)})(c):c;var{is:se,defineProperty:ie,getOwnPropertyDescriptor:ne,getOwnPropertyNames:oe,getOwnPropertySymbols:ae,getPrototypeOf:ce}=Object,vt=globalThis,Ft=vt.trustedTypes,de=Ft?Ft.emptyScript:"",le=vt.reactiveElementPolyfillSupport,Q=(c,t)=>c,St={toAttribute(c,t){switch(t){case Boolean:c=c?de:null;break;case Object:case Array:c=c==null?c:JSON.stringify(c)}return c},fromAttribute(c,t){let e=c;switch(t){case Boolean:e=c!==null;break;case Number:e=c===null?null:Number(c);break;case Object:case Array:try{e=JSON.parse(c)}catch{e=null}}return e}},jt=(c,t)=>!se(c,t),Vt={attribute:!0,type:String,converter:St,reflect:!1,useDefault:!1,hasChanged:jt};Symbol.metadata??=Symbol("metadata"),vt.litPropertyMetadata??=new WeakMap;var S=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Vt){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let r=Symbol(),s=this.getPropertyDescriptor(t,r,e);s!==void 0&&ie(this.prototype,t,s)}}static getPropertyDescriptor(t,e,r){let{get:s,set:i}=ne(this.prototype,t)??{get(){return this[e]},set(n){this[e]=n}};return{get:s,set(n){let o=s?.call(this);i?.call(this,n),this.requestUpdate(t,o,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Vt}static _$Ei(){if(this.hasOwnProperty(Q("elementProperties")))return;let t=ce(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Q("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Q("properties"))){let e=this.properties,r=[...oe(e),...ae(e)];for(let s of r)this.createProperty(s,e[s])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[r,s]of e)this.elementProperties.set(r,s)}this._$Eh=new Map;for(let[e,r]of this.elementProperties){let s=this._$Eu(e,r);s!==void 0&&this._$Eh.set(s,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let r=new Set(t.flat(1/0).reverse());for(let s of r)e.unshift(wt(s))}else t!==void 0&&e.push(wt(t));return e}static _$Eu(t,e){let r=e.attribute;return r===!1?void 0:typeof r=="string"?r:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let r of e.keys())this.hasOwnProperty(r)&&(t.set(r,this[r]),delete this[r]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ut(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,r){this._$AK(t,r)}_$ET(t,e){let r=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,r);if(s!==void 0&&r.reflect===!0){let i=(r.converter?.toAttribute!==void 0?r.converter:St).toAttribute(e,r.type);this._$Em=t,i==null?this.removeAttribute(s):this.setAttribute(s,i),this._$Em=null}}_$AK(t,e){let r=this.constructor,s=r._$Eh.get(t);if(s!==void 0&&this._$Em!==s){let i=r.getPropertyOptions(s),n=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:St;this._$Em=s;let o=n.fromAttribute(e,i.type);this[s]=o??this._$Ej?.get(s)??o,this._$Em=null}}requestUpdate(t,e,r,s=!1,i){if(t!==void 0){let n=this.constructor;if(s===!1&&(i=this[t]),r??=n.getPropertyOptions(t),!((r.hasChanged??jt)(i,e)||r.useDefault&&r.reflect&&i===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,r))))return;this.C(t,e,r)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:r,reflect:s,wrapped:i},n){r&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),i!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||r||(e=void 0),this._$AL.set(t,e)),s===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,i]of this._$Ep)this[s]=i;this._$Ep=void 0}let r=this.constructor.elementProperties;if(r.size>0)for(let[s,i]of r){let{wrapped:n}=i,o=this[s];n!==!0||this._$AL.has(s)||o===void 0||this.C(s,void 0,i,o)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(r=>r.hostUpdate?.()),this.update(e)):this._$EM()}catch(r){throw t=!1,this._$EM(),r}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};S.elementStyles=[],S.shadowRootOptions={mode:"open"},S[Q("elementProperties")]=new Map,S[Q("finalized")]=new Map,le?.({ReactiveElement:S}),(vt.reactiveElementVersions??=[]).push("2.1.2");var Pt=globalThis,Wt=c=>c,gt=Pt.trustedTypes,qt=gt?gt.createPolicy("lit-html",{createHTML:c=>c}):void 0,Qt="$lit$",L=`lit$${Math.random().toFixed(9).slice(2)}$`,Zt="?"+L,he=`<${Zt}>`,I=document,tt=()=>I.createComment(""),et=c=>c===null||typeof c!="object"&&typeof c!="function",Rt=Array.isArray,ue=c=>Rt(c)||typeof c?.[Symbol.iterator]=="function",Et=`[ 	
\f\r]`,Z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Kt=/-->/g,Yt=/>/g,R=RegExp(`>|${Et}(?:([^\\s"'>=/]+)(${Et}*=${Et}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Xt=/'/g,Gt=/"/g,te=/^(?:script|style|textarea|title)$/i,Nt=c=>(t,...e)=>({_$litType$:c,strings:t,values:e}),v=Nt(1),it=Nt(2),$e=Nt(3),z=Symbol.for("lit-noChange"),l=Symbol.for("lit-nothing"),Jt=new WeakMap,N=I.createTreeWalker(I,129);function ee(c,t){if(!Rt(c)||!c.hasOwnProperty("raw"))throw Error("invalid template strings array");return qt!==void 0?qt.createHTML(t):t}var pe=(c,t)=>{let e=c.length-1,r=[],s,i=t===2?"<svg>":t===3?"<math>":"",n=Z;for(let o=0;o<e;o++){let a=c[o],d,p,h=-1,f=0;for(;f<a.length&&(n.lastIndex=f,p=n.exec(a),p!==null);)f=n.lastIndex,n===Z?p[1]==="!--"?n=Kt:p[1]!==void 0?n=Yt:p[2]!==void 0?(te.test(p[2])&&(s=RegExp("</"+p[2],"g")),n=R):p[3]!==void 0&&(n=R):n===R?p[0]===">"?(n=s??Z,h=-1):p[1]===void 0?h=-2:(h=n.lastIndex-p[2].length,d=p[1],n=p[3]===void 0?R:p[3]==='"'?Gt:Xt):n===Gt||n===Xt?n=R:n===Kt||n===Yt?n=Z:(n=R,s=void 0);let m=n===R&&c[o+1].startsWith("/>")?" ":"";i+=n===Z?a+he:h>=0?(r.push(d),a.slice(0,h)+Qt+a.slice(h)+L+m):a+L+(h===-2?o:m)}return[ee(c,i+(c[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]},rt=class c{constructor({strings:t,_$litType$:e},r){let s;this.parts=[];let i=0,n=0,o=t.length-1,a=this.parts,[d,p]=pe(t,e);if(this.el=c.createElement(d,r),N.currentNode=this.el.content,e===2||e===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(s=N.nextNode())!==null&&a.length<o;){if(s.nodeType===1){if(s.hasAttributes())for(let h of s.getAttributeNames())if(h.endsWith(Qt)){let f=p[n++],m=s.getAttribute(h).split(L),b=/([.?@])?(.*)/.exec(f);a.push({type:1,index:i,name:b[2],strings:m,ctor:b[1]==="."?Ct:b[1]==="?"?Lt:b[1]==="@"?kt:U}),s.removeAttribute(h)}else h.startsWith(L)&&(a.push({type:6,index:i}),s.removeAttribute(h));if(te.test(s.tagName)){let h=s.textContent.split(L),f=h.length-1;if(f>0){s.textContent=gt?gt.emptyScript:"";for(let m=0;m<f;m++)s.append(h[m],tt()),N.nextNode(),a.push({type:2,index:++i});s.append(h[f],tt())}}}else if(s.nodeType===8)if(s.data===Zt)a.push({type:2,index:i});else{let h=-1;for(;(h=s.data.indexOf(L,h+1))!==-1;)a.push({type:7,index:i}),h+=L.length-1}i++}}static createElement(t,e){let r=I.createElement("template");return r.innerHTML=t,r}};function D(c,t,e=c,r){if(t===z)return t;let s=r!==void 0?e._$Co?.[r]:e._$Cl,i=et(t)?void 0:t._$litDirective$;return s?.constructor!==i&&(s?._$AO?.(!1),i===void 0?s=void 0:(s=new i(c),s._$AT(c,e,r)),r!==void 0?(e._$Co??=[])[r]=s:e._$Cl=s),s!==void 0&&(t=D(c,s._$AS(c,t.values),s,r)),t}var At=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:r}=this._$AD,s=(t?.creationScope??I).importNode(e,!0);N.currentNode=s;let i=N.nextNode(),n=0,o=0,a=r[0];for(;a!==void 0;){if(n===a.index){let d;a.type===2?d=new st(i,i.nextSibling,this,t):a.type===1?d=new a.ctor(i,a.name,a.strings,this,t):a.type===6&&(d=new Mt(i,this,t)),this._$AV.push(d),a=r[++o]}n!==a?.index&&(i=N.nextNode(),n++)}return N.currentNode=I,s}p(t){let e=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,e),e+=r.strings.length-2):r._$AI(t[e])),e++}},st=class c{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,r,s){this.type=2,this._$AH=l,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=r,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=D(this,t,e),et(t)?t===l||t==null||t===""?(this._$AH!==l&&this._$AR(),this._$AH=l):t!==this._$AH&&t!==z&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ue(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==l&&et(this._$AH)?this._$AA.nextSibling.data=t:this.T(I.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:r}=t,s=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=rt.createElement(ee(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===s)this._$AH.p(e);else{let i=new At(s,this),n=i.u(this.options);i.p(e),this.T(n),this._$AH=i}}_$AC(t){let e=Jt.get(t.strings);return e===void 0&&Jt.set(t.strings,e=new rt(t)),e}k(t){Rt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,r,s=0;for(let i of t)s===e.length?e.push(r=new c(this.O(tt()),this.O(tt()),this,this.options)):r=e[s],r._$AI(i),s++;s<e.length&&(this._$AR(r&&r._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let r=Wt(t).nextSibling;Wt(t).remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},U=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,r,s,i){this.type=1,this._$AH=l,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=i,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=l}_$AI(t,e=this,r,s){let i=this.strings,n=!1;if(i===void 0)t=D(this,t,e,0),n=!et(t)||t!==this._$AH&&t!==z,n&&(this._$AH=t);else{let o=t,a,d;for(t=i[0],a=0;a<i.length-1;a++)d=D(this,o[r+a],e,a),d===z&&(d=this._$AH[a]),n||=!et(d)||d!==this._$AH[a],d===l?t=l:t!==l&&(t+=(d??"")+i[a+1]),this._$AH[a]=d}n&&!s&&this.j(t)}j(t){t===l?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Ct=class extends U{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===l?void 0:t}},Lt=class extends U{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==l)}},kt=class extends U{constructor(t,e,r,s,i){super(t,e,r,s,i),this.type=5}_$AI(t,e=this){if((t=D(this,t,e,0)??l)===z)return;let r=this._$AH,s=t===l&&r!==l||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,i=t!==l&&(r===l||s);s&&this.element.removeEventListener(this.name,this,r),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Mt=class{constructor(t,e,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){D(this,t)}};var ve=Pt.litHtmlPolyfillSupport;ve?.(rt,st),(Pt.litHtmlVersions??=[]).push("3.3.2");var re=(c,t,e)=>{let r=e?.renderBefore??t,s=r._$litPart$;if(s===void 0){let i=e?.renderBefore??null;r._$litPart$=s=new st(t.insertBefore(tt(),i),i,void 0,e??{})}return s._$AI(c),s};var It=globalThis,E=class extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=re(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return z}};E._$litElement$=!0,E.finalized=!0,It.litElementHydrateSupport?.({LitElement:E});var ge=It.litElementPolyfillSupport;ge?.({LitElement:E});(It.litElementVersions??=[]).push("4.2.2");var zt=class c extends E{static LAYOUT_BUILD_MARKER="v1.0.19-1-ga1f1d1e-dirty";_hass;config;optimisticPowerState;resolvedEntities={};resolvedLayerSourceEntities=[];resolvedDeviceId;resolvingDeviceId;resolvedForHass;lastRelevantStateSignature="";activeLayerSourceChooser;presetChooserOpen=!1;presetAnchorRect;layerAnchorRect;static properties={hass:{attribute:!1,noAccessor:!0},config:{attribute:!1}};get hass(){return this._hass}set hass(t){let e=this._hass;this._hass=t;let r=this.buildRelevantStateSignature(t),s=r!==this.lastRelevantStateSignature;this.lastRelevantStateSignature=r,(e!==t||s)&&this.requestUpdate("hass",e)}setConfig(t){let e={...t};e.type||="custom:novastar-h-series-card",this.config=e}getCardSize(){return 3}static async getConfigElement(){return document.createElement("novastar-h-series-card-editor")}static getStubConfig(){return{type:"custom:novastar-h-series-card",header:"Novastar H Series"}}updated(){this.ensureResolvedEntities(),this.syncOptimisticPowerState(),this.syncChooserPopovers()}syncChooserPopovers(){let t=this.renderRoot,e=t.getElementById("nova-preset-popover");e&&this.presetChooserOpen&&!e.matches(":popover-open")&&(e.showPopover?.(),this.positionChooserPopover(e,this.presetAnchorRect));let r=t.getElementById("nova-layer-popover");r&&this.activeLayerSourceChooser&&!r.matches(":popover-open")&&(r.showPopover?.(),this.positionChooserPopover(r,this.layerAnchorRect))}positionChooserPopover(t,e){let s=window.innerWidth,i=window.innerHeight,n=t.getBoundingClientRect();if(t.style.position="fixed",t.style.margin="0",!e){t.style.left=`${Math.round((s-n.width)/2)}px`,t.style.top=`${Math.round((i-n.height)/2)}px`;return}let o=e.right-n.width;o=Math.max(8,Math.min(o,s-n.width-8));let a=e.bottom+8;a+n.height>i-8&&e.top-8-n.height>=8&&(a=e.top-8-n.height),a=Math.max(8,Math.min(a,i-n.height-8)),t.style.left=`${Math.round(o)}px`,t.style.top=`${Math.round(a)}px`}render(){if(!this.config)return v`<ha-card><div class="content">Invalid card configuration.</div></ha-card>`;if(!this.hass)return v`<ha-card><div class="content">Home Assistant context is unavailable.</div></ha-card>`;let t=this.getEntityId("controller_entity");if(!t){let _t=this.config.device_id&&this.resolvingDeviceId===this.config.device_id?"Resolving entities for selected device...":"Set a device_id or controller_entity in card configuration.";return v`<ha-card><div class="content">${_t}</div></ha-card>`}let e=this.hass.states[t];if(!e)return v`<ha-card><div class="content">Entity not found: ${t}</div></ha-card>`;let r=this.getEntityId("power_entity")??"switch.novastar_h2_power_screen_output",s=this.getEntityId("preset_entity"),i=this.getEntityId("screens_entity"),n=this.getEntityId("layers_entity"),o=this.getEntityId("status_entity"),a=this.getEntityId("brightness_entity"),d=this.getEntityId("temperature_entity"),p=this.hass.states[r],f=(this.optimisticPowerState??p?.state)==="on",m=!!p&&!f,b=o?this.hass.states[o]:void 0,A=s?this.hass.states[s]:void 0,nt=i?this.hass.states[i]:void 0,g=n?this.hass.states[n]:void 0,y=a?this.hass.states[a]:void 0,$=d?this.hass.states[d]:void 0,k=y?Number.parseFloat(y.state):Number.NaN,F=y?this.readNumberAttribute(y,"min",0):0,V=y?this.readNumberAttribute(y,"max",100):100,j=y?this.readNumberAttribute(y,"step",1):1,ot=!!y&&Number.isFinite(k),W=y?this.readStringAttribute(y,"unit_of_measurement")??"":"",H=this.readStringListAttribute(A,"options"),C=A?this.resolveSelectedOption(A,H):"",q=this.readLayoutPayload(nt,g),K=b?`${e.state} (${b.state})`:e.state,at=$?this.readStringAttribute($,"unit_of_measurement")??"":"",M=this.getDisplayMode(),ft=this.getThemeMode(),P=M==="compact",x=M==="detailed",ct=this.config.show_header_in_compact===!0,mt=!P||ct,Y=P&&!ct,u=this.config.header??"Novastar H Series",dt=["content",`content--${M}`,Y?"content--bare":""].filter(Boolean).join(" "),w=!x&&!!p,_=!x&&!!$,O=!x&&ot,yt=w||_||O,X=this.getTemperatureSeverity($?.state),bt=this.getLayoutColorStyle();return v`
      <ha-card
        class="nova-card nova-card--${M} nova-card--theme-${ft} ${f?"is-on":"is-off"}"
        style=${bt}
      >
        ${mt?v`
                  ...
                  ${yt?v`
                        <div class="header-status">
                          ...
                          ${_?v`<span
                              ...
                              ></span>`:l}
                          ${O?this.renderHeaderBrightnessToggle(F,V,j,k,m,W):l}
                        </div>
                      `:l}
          ...
          ${x?v`
                ...
                ${y?v`
                      <div class="row input-row">
                        ...
                        ${ot?this.renderBrightnessControl(F,V,j,k,m,W):v`<span class="value">${y.state}${W}</span>`}
                      </div>
                    `:l}
              `:l}
          ${!P&&A?this.renderPresetArea(H,C,m,x,A):l}
          ${q?this.renderLayoutPreview(q,Y):P?v`<div class="row"><span class="label">Layout</span><span class="value">Unavailable</span></div>`:l}
          ${x?this.renderVersionFooter():l}
        </div>
        ${this.presetChooserOpen&&A&&H.length>0?this.renderPresetChooser(H,C,m):l}
      </ha-card>
    `}getDisplayMode(){let t=this.config?.display_mode;return t==="detailed"||t==="compact"?t:"standard"}getThemeMode(){return this.config?.theme==="ha"?"ha":"nova"}getTemperatureSeverity(t){let e=(t??"").trim().toLowerCase();return e==="normal"?"normal":e==="warning"?"warning":e==="critical"?"critical":"unknown"}resolveConfigColor(t){if(typeof t!="string")return;let e=t.trim();if(e){if(/^#([0-9a-f]{3,4}|[0-9a-f]{6}|[0-9a-f]{8})$/i.test(e)||/^(rgb|rgba|hsl|hsla)\(/i.test(e))return e;if(/^[a-z]+(-[a-z]+)*$/i.test(e))return`var(--${e}-color)`}}getLayoutColorStyle(){let t=[],e=this.resolveConfigColor(this.config?.screen_color);e&&t.push(`--nova-layer: ${e};`);let r=this.resolveConfigColor(this.config?.screen_background_color);return r&&t.push(`--nova-screen: ${r};`),t.join(" ")}renderPowerButton(t){return v`
      <button
        type="button"
    ...
    `}renderHeaderBrightnessToggle(t,e,r,s,i,n){let o=e-t||1,a=Math.max(0,Math.min(100,Math.round((s-t)/o*100))),d=n?`${Math.round(s)}${n}`:`${a}%`;return v`
      <button
        type="button"
        class="icon-button"
    ...
    `}renderPresetArea(t,e,r,s,i){if(t.length===0)return v`
        <div class="preset-area">
          ${s?v`<div class="preset-heading">Presets</div>`:l}
          <div class="row"><span class="value">${i.state}</span></div>
        </div>
      `;let n=s?t:t.slice(0,4);return v`
      <div class="preset-area">
        ${s?v`<div class="preset-heading">Presets</div>`:l}
        <div class="preset-grid" role="group" aria-label="Presets">
          ${n.map(o=>{let a=this.optionEquals(o,e);return v`
              <button
                type="button"
                class="preset-button ${a?"preset-button--active":""}"
                ?disabled=${r}
                aria-pressed=${a?"true":"false"}
                title=${o}
                @click=${()=>this.handlePresetButtonClick(o)}
              ><span class="preset-button-label">${o}</span></button>
            `})}
          ${s?l:v`
                <button
                  type="button"
    ...
    `}renderPresetChooser(t,e,r){return v`
      <div
      ...
      >
        ...
        <div class="nova-popover-options">
          ${t.map(s=>v`
            <button
              type="button"
              class="nova-popover-option ${this.optionEquals(s,e)?"selected":""}"
              ?disabled=${r}
    ...
    `}handlePresetPopoverToggle=t=>{t.newState==="closed"&&this.presetChooserOpen&&(this.presetChooserOpen=!1,this.requestUpdate())};openPresetChooser=t=>{let e=t.currentTarget;this.presetAnchorRect=e?.getBoundingClientRect(),this.presetChooserOpen=!0,this.requestUpdate()};closePresetChooser=()=>{this.presetChooserOpen=!1,this.requestUpdate()};async handlePresetChooserOptionClick(t){this.presetChooserOpen=!1,this.requestUpdate(),await this.handlePresetButtonClick(t)}renderVersionFooter(){return v`<div class="version-footer">${c.LAYOUT_BUILD_MARKER}</div>`}static styles=pt`
    :host {
  ...
  `;renderLayoutPreview(t,e=!1){let r=t.screenWidth,s=t.screenHeight,i=this.fitLayersToViewport(t.layers,r,s).sort((g,y)=>g.z-y.z),n="#000000",o="#4a4a4a",a="#d9d9d9",d="#808080",p="#ffffff",h=this.getLayerSourceRows(),f=this.getLayerSourceLabelMap(),m=this.getEntityId("power_entity")??"switch.novastar_h2_power_screen_output",b=this.hass?.states[m],A=this.optimisticPowerState??b?.state,nt=!!b&&A!=="on";return v`
      <div class=${e?"layout-preview layout-preview--compact":"layout-preview"}>
        ...
        >
          ...
          ${i.map((g,y)=>{let $=this.resolveLayerSourceRow(h,g.id,y),k=this.resolveLayerSourceLabel(f,g.id,y)??g.source?.trim()??g.id,F=g.x+g.width/2,V=g.y+g.height/2,j=Math.min(g.width,g.height),ot=Math.max(54,r*.017),W=Math.max(j*.14,ot),H=Math.max(24,g.height*.38),C=Math.min(W,H),q=Math.max(18,C*.35),K=Math.max(32,g.width*.9),at=Math.max(1,Math.floor((K-q*2)/Math.max(1,C*.62))),M=k.length<=at?k:`${k.slice(0,Math.max(1,at-1))}\u2026`,ft=M.length*C*.62,P=Math.min(K,ft+q*2),x=Math.max(28,C*1.35),ct=F-P/2,mt=V-x/2,Y=Math.max(6,x*.25),u=Math.max(51,Math.min(138,j*.27)),dt=Math.max(10,u*.22),w=Math.max(g.x+4,g.x+g.width-u-dt),_=Math.min(g.y+dt,g.y+g.height-u-4),O=w+u*.22,yt=_+u*.34,X=u*.18,bt=u*.32,_t=[`${O+X},${_+u*.26}`,`${w+u*.68},${_+u*.16}`,`${w+u*.68},${_+u*.84}`,`${O+X},${_+u*.74}`].join(" "),B=w+u*.7,T=_+u*.5,Ot=g.audioOpen===!0,Bt=g.audioOpen===!1,G=Ot?"var(--success-color, #43a047)":Bt?"var(--secondary-text-color, #8a8a8a)":"color-mix(in srgb, var(--secondary-text-color, #8a8a8a) 55%, transparent)",lt=!!$&&!nt;return it`
              <g>
                <rect
                  class="layout-layer"
                  x=${g.x}
                ...
                <g>
                  ...
                  <rect
                    ...
                    fill=${G}
                  ></rect>
                  <polygon points=${_t} fill=${G}></polygon>
                  ${Ot?it`
                      <path
                        d=${`M ${B} ${T-u*.13} Q ${B+u*.12} ${T} ${B} ${T+u*.13}`}
                        fill="none"
                        stroke=${G}
                        stroke-width=${u*.06}
                      ...
                      ></path>
                      <path
                        d=${`M ${B+u*.1} ${T-u*.22} Q ${B+u*.28} ${T} ${B+u*.1} ${T+u*.22}`}
                        fill="none"
                        stroke=${G}
                        stroke-width=${u*.06}
                        stroke-linecap="round"
                ...
                <rect
                  ...
                  fill="#111111"
                  fill-opacity="0.82"
                  @click=${lt?$t=>this.openLayerSourceChooser($,$t):l}
                ></rect>
                <text
                  class=${lt?"layout-layer-hitbox":""}
                  x=${F}
                  y=${V}
                  font-weight="700"
                  style=${`fill:${p};font-size:${C}px;font-family:inherit;`}
                  text-anchor="middle"
    ...
    `}getLayerSourceLabelMap(){let t=new Map;for(let e of this.getLayerSourceRows()){let r=this.resolveSelectedOption(e.entity,e.options).trim();r&&t.set(e.layerNumber,r)}return t}resolveLayerSourceLabel(t,e,r){let s=[],i=Number.parseInt(e,10);Number.isFinite(i)&&(s.push(i),s.push(i+1)),s.push(r),s.push(r+1);for(let n of s){let o=t.get(n)?.trim();if(o)return o}}resolveLayerSourceRow(t,e,r){let s=[],i=Number.parseInt(e,10);Number.isFinite(i)&&(s.push(i),s.push(i+1)),s.push(r),s.push(r+1);for(let n of s){let o=t.find(a=>a.layerNumber===n);if(o)return o}return t[r]}renderLayerSourceChooser(t){let e=this.activeLayerSourceChooser;return e?v`
      <div
      ...
      >
        <div class="nova-popover-title">Layer ${e.layerNumber} Source</div>
        <div class="nova-popover-options">
          ${e.options.map(r=>v`
            <button
              type="button"
              class="nova-popover-option ${this.optionEquals(r,e.selectedOption)?"selected":""}"
              ?disabled=${t}
