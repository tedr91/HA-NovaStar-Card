var W=globalThis,Y=W.ShadowRoot&&(W.ShadyCSS===void 0||W.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Z=Symbol(),gt=new WeakMap,M=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==Z)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(Y&&t===void 0){let i=e!==void 0&&e.length===1;i&&(t=gt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&gt.set(e,t))}return t}toString(){return this.cssText}},ft=a=>new M(typeof a=="string"?a:a+"",void 0,Z),X=(a,...t)=>{let e=a.length===1?a[0]:t.reduce((i,s,r)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+a[r+1],a[0]);return new M(e,a,Z)},vt=(a,t)=>{if(Y)a.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let i=document.createElement("style"),s=W.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=e.cssText,a.appendChild(i)}},Q=Y?a=>a:a=>a instanceof CSSStyleSheet?(t=>{let e="";for(let i of t.cssRules)e+=i.cssText;return ft(e)})(a):a;var{is:Mt,defineProperty:Ot,getOwnPropertyDescriptor:Ht,getOwnPropertyNames:Tt,getOwnPropertySymbols:Ut,getPrototypeOf:Vt}=Object,K=globalThis,mt=K.trustedTypes,zt=mt?mt.emptyScript:"",Bt=K.reactiveElementPolyfillSupport,O=(a,t)=>a,tt={toAttribute(a,t){switch(t){case Boolean:a=a?zt:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,t){let e=a;switch(t){case Boolean:e=a!==null;break;case Number:e=a===null?null:Number(a);break;case Object:case Array:try{e=JSON.parse(a)}catch{e=null}}return e}},bt=(a,t)=>!Mt(a,t),_t={attribute:!0,type:String,converter:tt,reflect:!1,useDefault:!1,hasChanged:bt};Symbol.metadata??=Symbol("metadata"),K.litPropertyMetadata??=new WeakMap;var E=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=_t){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(t,i,e);s!==void 0&&Ot(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){let{get:s,set:r}=Ht(this.prototype,t)??{get(){return this[e]},set(n){this[e]=n}};return{get:s,set(n){let o=s?.call(this);r?.call(this,n),this.requestUpdate(t,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??_t}static _$Ei(){if(this.hasOwnProperty(O("elementProperties")))return;let t=Vt(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(O("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(O("properties"))){let e=this.properties,i=[...Tt(e),...Ut(e)];for(let s of i)this.createProperty(s,e[s])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[i,s]of e)this.elementProperties.set(i,s)}this._$Eh=new Map;for(let[e,i]of this.elementProperties){let s=this._$Eu(e,i);s!==void 0&&this._$Eh.set(s,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let s of i)e.unshift(Q(s))}else t!==void 0&&e.push(Q(t));return e}static _$Eu(t,e){let i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return vt(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){let i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(s!==void 0&&i.reflect===!0){let r=(i.converter?.toAttribute!==void 0?i.converter:tt).toAttribute(e,i.type);this._$Em=t,r==null?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){let i=this.constructor,s=i._$Eh.get(t);if(s!==void 0&&this._$Em!==s){let r=i.getPropertyOptions(s),n=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:tt;this._$Em=s;let o=n.fromAttribute(e,r.type);this[s]=o??this._$Ej?.get(s)??o,this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(t!==void 0){let n=this.constructor;if(s===!1&&(r=this[t]),i??=n.getPropertyOptions(t),!((i.hasChanged??bt)(r,e)||i.useDefault&&i.reflect&&r===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,i))))return;this.C(t,e,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:s,wrapped:r},n){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),r!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),s===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,r]of this._$Ep)this[s]=r;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[s,r]of i){let{wrapped:n}=r,o=this[s];n!==!0||this._$AL.has(s)||o===void 0||this.C(s,void 0,r,o)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(e)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};E.elementStyles=[],E.shadowRootOptions={mode:"open"},E[O("elementProperties")]=new Map,E[O("finalized")]=new Map,Bt?.({ReactiveElement:E}),(K.reactiveElementVersions??=[]).push("2.1.2");var ot=globalThis,$t=a=>a,G=ot.trustedTypes,wt=G?G.createPolicy("lit-html",{createHTML:a=>a}):void 0,Lt="$lit$",x=`lit$${Math.random().toFixed(9).slice(2)}$`,kt="?"+x,Ft=`<${kt}>`,k=document,T=()=>k.createComment(""),U=a=>a===null||typeof a!="object"&&typeof a!="function",dt=Array.isArray,jt=a=>dt(a)||typeof a?.[Symbol.iterator]=="function",et=`[ 	
\f\r]`,H=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Et=/-->/g,At=/>/g,C=RegExp(`>|${et}(?:([^\\s"'>=/]+)(${et}*=${et}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),St=/'/g,xt=/"/g,Nt=/^(?:script|style|textarea|title)$/i,ct=a=>(t,...e)=>({_$litType$:a,strings:t,values:e}),f=ct(1),lt=ct(2),Zt=ct(3),N=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),Ct=new WeakMap,L=k.createTreeWalker(k,129);function It(a,t){if(!dt(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return wt!==void 0?wt.createHTML(t):t}var qt=(a,t)=>{let e=a.length-1,i=[],s,r=t===2?"<svg>":t===3?"<math>":"",n=H;for(let o=0;o<e;o++){let d=a[o],c,p,h=-1,u=0;for(;u<d.length&&(n.lastIndex=u,p=n.exec(d),p!==null);)u=n.lastIndex,n===H?p[1]==="!--"?n=Et:p[1]!==void 0?n=At:p[2]!==void 0?(Nt.test(p[2])&&(s=RegExp("</"+p[2],"g")),n=C):p[3]!==void 0&&(n=C):n===C?p[0]===">"?(n=s??H,h=-1):p[1]===void 0?h=-2:(h=n.lastIndex-p[2].length,c=p[1],n=p[3]===void 0?C:p[3]==='"'?xt:St):n===xt||n===St?n=C:n===Et||n===At?n=H:(n=C,s=void 0);let g=n===C&&a[o+1].startsWith("/>")?" ":"";r+=n===H?d+Ft:h>=0?(i.push(c),d.slice(0,h)+Lt+d.slice(h)+x+g):d+x+(h===-2?o:g)}return[It(a,r+(a[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]},V=class a{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0,o=t.length-1,d=this.parts,[c,p]=qt(t,e);if(this.el=a.createElement(c,i),L.currentNode=this.el.content,e===2||e===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(s=L.nextNode())!==null&&d.length<o;){if(s.nodeType===1){if(s.hasAttributes())for(let h of s.getAttributeNames())if(h.endsWith(Lt)){let u=p[n++],g=s.getAttribute(h).split(x),m=/([.?@])?(.*)/.exec(u);d.push({type:1,index:r,name:m[2],strings:g,ctor:m[1]==="."?st:m[1]==="?"?rt:m[1]==="@"?nt:D}),s.removeAttribute(h)}else h.startsWith(x)&&(d.push({type:6,index:r}),s.removeAttribute(h));if(Nt.test(s.tagName)){let h=s.textContent.split(x),u=h.length-1;if(u>0){s.textContent=G?G.emptyScript:"";for(let g=0;g<u;g++)s.append(h[g],T()),L.nextNode(),d.push({type:2,index:++r});s.append(h[u],T())}}}else if(s.nodeType===8)if(s.data===kt)d.push({type:2,index:r});else{let h=-1;for(;(h=s.data.indexOf(x,h+1))!==-1;)d.push({type:7,index:r}),h+=x.length-1}r++}}static createElement(t,e){let i=k.createElement("template");return i.innerHTML=t,i}};function I(a,t,e=a,i){if(t===N)return t;let s=i!==void 0?e._$Co?.[i]:e._$Cl,r=U(t)?void 0:t._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),r===void 0?s=void 0:(s=new r(a),s._$AT(a,e,i)),i!==void 0?(e._$Co??=[])[i]=s:e._$Cl=s),s!==void 0&&(t=I(a,s._$AS(a,t.values),s,i)),t}var it=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??k).importNode(e,!0);L.currentNode=s;let r=L.nextNode(),n=0,o=0,d=i[0];for(;d!==void 0;){if(n===d.index){let c;d.type===2?c=new z(r,r.nextSibling,this,t):d.type===1?c=new d.ctor(r,d.name,d.strings,this,t):d.type===6&&(c=new at(r,this,t)),this._$AV.push(c),d=i[++o]}n!==d?.index&&(r=L.nextNode(),n++)}return L.currentNode=k,s}p(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},z=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=I(this,t,e),U(t)?t===y||t==null||t===""?(this._$AH!==y&&this._$AR(),this._$AH=y):t!==this._$AH&&t!==N&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):jt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==y&&U(this._$AH)?this._$AA.nextSibling.data=t:this.T(k.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:i}=t,s=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=V.createElement(It(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let r=new it(s,this),n=r.u(this.options);r.p(e),this.T(n),this._$AH=r}}_$AC(t){let e=Ct.get(t.strings);return e===void 0&&Ct.set(t.strings,e=new V(t)),e}k(t){dt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let r of t)s===e.length?e.push(i=new a(this.O(T()),this.O(T()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let i=$t(t).nextSibling;$t(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},D=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=y,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=y}_$AI(t,e=this,i,s){let r=this.strings,n=!1;if(r===void 0)t=I(this,t,e,0),n=!U(t)||t!==this._$AH&&t!==N,n&&(this._$AH=t);else{let o=t,d,c;for(t=r[0],d=0;d<r.length-1;d++)c=I(this,o[i+d],e,d),c===N&&(c=this._$AH[d]),n||=!U(c)||c!==this._$AH[d],c===y?t=y:t!==y&&(t+=(c??"")+r[d+1]),this._$AH[d]=c}n&&!s&&this.j(t)}j(t){t===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},st=class extends D{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===y?void 0:t}},rt=class extends D{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==y)}},nt=class extends D{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=I(this,t,e,0)??y)===N)return;let i=this._$AH,s=t===y&&i!==y||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==y&&(i===y||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},at=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){I(this,t)}};var Wt=ot.litHtmlPolyfillSupport;Wt?.(V,z),(ot.litHtmlVersions??=[]).push("3.3.2");var Dt=(a,t,e)=>{let i=e?.renderBefore??t,s=i._$litPart$;if(s===void 0){let r=e?.renderBefore??null;i._$litPart$=s=new z(t.insertBefore(T(),r),r,void 0,e??{})}return s._$AI(a),s};var ht=globalThis,A=class extends E{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Dt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return N}};A._$litElement$=!0,A.finalized=!0,ht.litElementHydrateSupport?.({LitElement:A});var Yt=ht.litElementPolyfillSupport;Yt?.({LitElement:A});(ht.litElementVersions??=[]).push("4.2.2");var ut=class a extends A{static LAYOUT_BUILD_MARKER="v0.2.21";_hass;config;optimisticPowerState;resolvedEntities={};resolvedLayerSourceEntities=[];resolvedDeviceId;resolvingDeviceId;resolvedForHass;lastRelevantStateSignature="";static properties={hass:{attribute:!1,noAccessor:!0},config:{attribute:!1}};get hass(){return this._hass}set hass(t){let e=this._hass;this._hass=t;let i=this.buildRelevantStateSignature(t),s=i!==this.lastRelevantStateSignature;this.lastRelevantStateSignature=i,(e!==t||s)&&this.requestUpdate("hass",e)}setConfig(t){let e={...t};e.type||="custom:novastar-h-series-card",this.config=e}getCardSize(){return 3}static async getConfigElement(){return document.createElement("novastar-h-series-card-editor")}static getStubConfig(){return{type:"custom:novastar-h-series-card",title:"Novastar H Series"}}updated(){this.ensureResolvedEntities(),this.syncOptimisticPowerState()}render(){if(!this.config)return f`<ha-card><div class="content">Invalid card configuration.</div></ha-card>`;if(!this.hass)return f`<ha-card><div class="content">Home Assistant context is unavailable.</div></ha-card>`;let t=this.getEntityId("controller_entity");if(!t){let w=this.config.device_id&&this.resolvingDeviceId===this.config.device_id?"Resolving entities for selected device...":"Set a device_id or controller_entity in card configuration.";return f`<ha-card><div class="content">${w}</div></ha-card>`}let e=this.hass.states[t];if(!e)return f`<ha-card><div class="content">Entity not found: ${t}</div></ha-card>`;let i=this.getEntityId("power_entity")??"switch.novastar_h2_power_screen_output",s=this.getEntityId("preset_entity"),r=this.getEntityId("screens_entity"),n=this.getEntityId("layers_entity"),o=this.getEntityId("status_entity"),d=this.getEntityId("brightness_entity"),c=this.getEntityId("temperature_entity"),p=this.hass.states[i],u=(this.optimisticPowerState??p?.state)==="on",g=!!p&&!u,m=o?this.hass.states[o]:void 0,l=s?this.hass.states[s]:void 0,_=r?this.hass.states[r]:void 0,b=n?this.hass.states[n]:void 0,v=d?this.hass.states[d]:void 0,S=c?this.hass.states[c]:void 0,$=v?Number.parseFloat(v.state):Number.NaN,B=v?this.readNumberAttribute(v,"min",0):0,F=v?this.readNumberAttribute(v,"max",100):100,j=v?this.readNumberAttribute(v,"step",1):1,q=v&&Number.isFinite($),P=this.readStringListAttribute(l,"options"),Pt=this.getLayerSourceRows(),yt=this.readLayoutPayload(_,b),Rt=m?`${e.state} (${m.state})`:e.state;return f`
      <ha-card>
        ...
        <div class="content">
          ...
          ${S?f`<div class="row"><span class="label">Temperature</span><span class="value">${S.state}</span></div>`:y}
          ${l?P.length>0?(()=>{let w=this.resolveSelectedOption(l,P);return f`
                    <div class="row input-row">
                      ...
                      >
                        ${P.map(R=>f`
                          <option
                            .value=${R}
                            ?selected=${this.optionEquals(R,w)}
                          >${R}</option>
                        `)}
                      </select>
                    </div>
                  `})():f`<div class="row"><span class="label">Preset</span><span class="value">${l.state}</span></div>`:y}
          ${Pt.map(w=>{let R=this.resolveSelectedOption(w.entity,w.options);return f`
              <div class="row input-row">
                <span class="label">Layer ${w.layerNumber} Source</span>
                <select
                  class="input-select"
                  data-entity-id=${w.entityId}
                  .disabled=${g}
                  ?disabled=${g}
                ...
                >
                  ${w.options.map(J=>f`
                    <option
                      .value=${J}
                      ?selected=${this.optionEquals(J,R)}
                    >${J}</option>
                  `)}
                </select>
              </div>
            `})}
          ${yt?this.renderLayoutPreview(yt):y}
          ${v?q?y:f`<div class="row"><span class="label">Brightness</span><span class="value">${v.state}</span></div>`:y}
        </div>
      </ha-card>
    `}static styles=X`
    .header-row {
  ...
  `;renderLayoutPreview(t){let e=t.screenWidth,i=t.screenHeight,s=this.fitLayersToViewport(t.layers,e,i).sort((u,g)=>u.z-g.z),r="#000000",n="#4a4a4a",o="#d9d9d9",d="#808080",c="#ffffff",p=`layers: ${s.length}`,h=s.length===0?"geometry: none":`geometry: ${s.map((u,g)=>`${g}:${Math.round(u.x)},${Math.round(u.y)} ${Math.round(u.width)}x${Math.round(u.height)} z${u.z}`).join(" | ")}`;return f`
      <div class="layout-preview">
        ...
        >
          ...
          ${s.length===0?lt`<text class="layout-empty" x=${e/2} y=${i/2}>No layers detected</text>`:y}
          ${s.map((u,g)=>{let m=u.source?.trim()||u.id,l=u.x+2,_=u.y+10;return lt`
              <g>
                <rect
                  class="layout-layer"
                  x=${u.x}
  ...
  `};try{customElements.define("novastar-h-series-card",ut)}catch{}try{customElements.define("novastar-h-series-card-editor",pt)}catch{}window.customCards=window.customCards||[];window.customCards.push({type:"novastar-h-series-card",name:"Novastar H Series Card",description:"Displays core status information for a Novastar H Series controller from device or entity config."});export{ut as NovastarHSeriesCard};
