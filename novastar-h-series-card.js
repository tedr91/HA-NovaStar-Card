      ...
      <ha-card>
        ...
        <div class="content">
          ...
          ${c?v`
              ...
              `:d}
          ${l?v`<div class="row"><span class="label">Temperature</span><span class="value">${l.state}</span></div>`:d}
          ${h?mt?v`
                ...
                `:v`<div class="row"><span class="label">Brightness</span><span class="value">${h.state}</span></div>`:d}
        </div>
      </ha-card>
    `}static styles=M`
    .header {
