...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ct=/'/g,Lt=/"/g,Dt=/^(?:script|style|textarea|title)$/i,ut=a=>(t,...e)=>({_$litType$:a,strings:t,values:e}),g=ut(1),pt=ut(2),Zt=ut(3),L=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),Nt=new WeakMap,x=C.createTreeWalker(C,129);function Pt(a,t){if(!ht(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return At!==void 0?At.createHTML(t):t}var Wt=(a,t)=>{let e=a.length-1,i=[],s,r=t===2?"<svg>":t===3?"<math>":"",n=H;for(let o=0;o<e;o++){let d=a[o],l,h,c=-1,p=0;for(;p<d.length&&(n.lastIndex=p,h=n.exec(d),h!==null);)p=n.lastIndex,n===H?h[1]==="!--"?n=St:h[1]!==void 0?n=xt:h[2]!==void 0?(Dt.test(h[2])&&(s=RegExp("</"+h[2],"g")),n=S):h[3]!==void 0&&(n=S):n===S?h[0]===">"?(n=s??H,c=-1):h[1]===void 0?c=-2:(c=n.lastIndex-h[2].length,l=h[1],n=h[3]===void 0?S:h[3]==='"'?Lt:Ct):n===Lt||n===Ct?n=S:n===St||n===xt?n=H:(n=S,s=void 0);let y=n===S&&a[o+1].startsWith("/>")?" ":"";r+=n===H?d+Bt:c>=0?(i.push(l),d.slice(0,c)+kt+d.slice(c)+E+y):d+E+(c===-2?o:y)}return[Pt(a,r+(a[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]},U=class a{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0,o=t.length-1,d=this.parts,[l,h]=Wt(t,e);if(this.el=a.createElement(l,i),x.currentNode=this.el.content,e===2||e===3){let c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(s=x.nextNode())!==null&&d.length<o;){if(s.nodeType===1){if(s.hasAttributes())for(let c of s.getAttributeNames())if(c.endsWith(kt)){let p=h[n++],y=s.getAttribute(c).split(E),v=/([.?@])?(.*)/.exec(p);d.push({type:1,index:r,name:v[2],strings:y,ctor:v[1]==="."?at:v[1]==="?"?ot:v[1]==="@"?dt:I}),s.removeAttribute(c)}else c.startsWith(E)&&(d.push({type:6,index:r}),s.removeAttribute(c));if(Dt.test(s.tagName)){let c=s.textContent.split(E),p=c.length-1;if(p>0){s.textContent=G?G.emptyScript:"";for(let y=0;y<p;y++)s.append(c[y],O()),x.nextNode(),d.push({type:2,index:++r});s.append(c[p],O())}}}else if(s.nodeType===8)if(s.data===It)d.push({type:2,index:r});else{let c=-1;for(;(c=s.data.indexOf(E,c+1))!==-1;)d.push({type:7,index:r}),c+=E.length-1}r++}}static createElement(t,e){let i=C.createElement("template");return i.innerHTML=t,i}};function k(a,t,e=a,i){if(t===L)return t;let s=i!==void 0?e._$Co?.[i]:e._$Cl,r=T(t)?void 0:t._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),r===void 0?s=void 0:(s=new r(a),s._$AT(a,e,i)),i!==void 0?(e._$Co??=[])[i]=s:e._$Cl=s),s!==void 0&&(t=k(a,s._$AS(a,t.values),s,i)),t}var nt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??C).importNode(e,!0);x.currentNode=s;let r=x.nextNode(),n=0,o=0,d=i[0];for(;d!==void 0;){if(n===d.index){let l;d.type===2?l=new z(r,r.nextSibling,this,t):d.type===1?l=new d.ctor(r,d.name,d.strings,this,t):d.type===6&&(l=new ct(r,this,t)),this._$AV.push(l),d=i[++o]}n!==d?.index&&(r=x.nextNode(),n++)}return x.currentNode=C,s}p(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},z=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=k(this,t,e),T(t)?t===u||t==null||t===""?(this._$AH!==u&&this._$AR(),this._$AH=u):t!==this._$AH&&t!==L&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):jt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==u&&T(this._$AH)?this._$AA.nextSibling.data=t:this.T(C.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:i}=t,s=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=U.createElement(Pt(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let r=new nt(s,this),n=r.u(this.options);r.p(e),this.T(n),this._$AH=r}}_$AC(t){let e=Nt.get(t.strings);return e===void 0&&Nt.set(t.strings,e=new U(t)),e}k(t){ht(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let r of t)s===e.length?e.push(i=new a(this.O(O()),this.O(O()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let i=Et(t).nextSibling;Et(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},I=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=u,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=u}_$AI(t,e=this,i,s){let r=this.strings,n=!1;if(r===void 0)t=k(this,t,e,0),n=!T(t)||t!==this._$AH&&t!==L,n&&(this._$AH=t);else{let o=t,d,l;for(t=r[0],d=0;d<r.length-1;d++)l=k(this,o[i+d],e,d),l===L&&(l=this._$AH[d]),n||=!T(l)||l!==this._$AH[d],l===u?t=u:t!==u&&(t+=(l??"")+r[d+1]),this._$AH[d]=l}n&&!s&&this.j(t)}j(t){t===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},at=class extends I{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===u?void 0:t}},ot=class extends I{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==u)}},dt=class extends I{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=k(this,t,e,0)??u)===L)return;let i=this._$AH,s=t===u&&i!==u||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==u&&(i===u||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},ct=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){k(this,t)}};var qt=lt.litHtmlPolyfillSupport;qt?.(U,z),(lt.litHtmlVersions??=[]).push("3.3.2");var Rt=(a,t,e)=>{let i=e?.renderBefore??t,s=i._$litPart$;if(s===void 0){let r=e?.renderBefore??null;i._$litPart$=s=new z(t.insertBefore(O(),r),r,void 0,e??{})}return s._$AI(a),s};var yt=globalThis,b=class extends _{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Rt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return L}};b._$litElement$=!0,b.finalized=!0,yt.litElementHydrateSupport?.({LitElement:b});var Kt=yt.litElementPolyfillSupport;Kt?.({LitElement:b});(yt.litElementVersions??=[]).push("4.2.2");var gt=class extends b{static LAYOUT_BUILD_MARKER="v0.2.28";_hass;config;optimisticPowerState;resolvedEntities={};resolvedLayerSourceEntities=[];resolvedDeviceId;resolvingDeviceId;resolvedForHass;lastRelevantStateSignature="";static properties={hass:{attribute:!1,noAccessor:!0},config:{attribute:!1}};get hass(){return this._hass}set hass(t){let e=this._hass;this._hass=t;let i=this.buildRelevantStateSignature(t),s=i!==this.lastRelevantStateSignature;this.lastRelevantStateSignature=i,(e!==t||s)&&this.requestUpdate("hass",e)}setConfig(t){let e={...t};e.type||="custom:novastar-h-series-card",this.config=e}getCardSize(){return 3}static async getConfigElement(){return document.createElement("novastar-h-series-card-editor")}static getStubConfig(){return{type:"custom:novastar-h-series-card",title:"Novastar H Series"}}updated(){this.ensureResolvedEntities(),this.syncOptimisticPowerState()}render(){if(!this.config)return g`<ha-card><div class="content">Invalid card configuration.</div></ha-card>`;if(!this.hass)return g`<ha-card><div class="content">Home Assistant context is unavailable.</div></ha-card>`;let t=this.getEntityId("controller_entity");if(!t){let m=this.config.device_id&&this.resolvingDeviceId===this.config.device_id?"Resolving entities for selected device...":"Set a device_id or controller_entity in card configuration.";return g`<ha-card><div class="content">${m}</div></ha-card>`}let e=this.hass.states[t];if(!e)return g`<ha-card><div class="content">Entity not found: ${t}</div></ha-card>`;let i=this.getEntityId("power_entity")??"switch.novastar_h2_power_screen_output",s=this.getEntityId("preset_entity"),r=this.getEntityId("screens_entity"),n=this.getEntityId("layers_entity"),o=this.getEntityId("status_entity"),d=this.getEntityId("brightness_entity"),l=this.getEntityId("temperature_entity"),h=this.hass.states[i],p=(this.optimisticPowerState??h?.state)==="on",y=!!h&&!p,v=o?this.hass.states[o]:void 0,A=s?this.hass.states[s]:void 0,J=r?this.hass.states[r]:void 0,Z=n?this.hass.states[n]:void 0,f=d?this.hass.states[d]:void 0,F=l?this.hass.states[l]:void 0,$=f?Number.parseFloat(f.state):Number.NaN,V=f?this.readNumberAttribute(f,"min",0):0,B=f?this.readNumberAttribute(f,"max",100):100,j=f?this.readNumberAttribute(f,"step",1):1,D=f&&Number.isFinite($),P=this.readStringListAttribute(A,"options"),W=this.getLayerSourceRows(),N=this.readLayoutPayload(J,Z),Q=v?`${e.state} (${v.state})`:e.state;return g`
      <ha-card>
        ...
        <div class="content">
          ...
          ${F?g`<div class="row"><span class="label">Temperature</span><span class="value">${F.state}</span></div>`:u}
          ${A?P.length>0?(()=>{let m=this.resolveSelectedOption(A,P);return g`
                    <div class="row input-row">
                      ...
                      >
                        ${P.map(w=>g`
                          <option
                            .value=${w}
                            ?selected=${this.optionEquals(w,m)}
                          >${w}</option>
                        `)}
                      </select>
                    </div>
                  `})():g`<div class="row"><span class="label">Preset</span><span class="value">${A.state}</span></div>`:u}
          ${W.map(m=>{let w=this.resolveSelectedOption(m.entity,m.options);return g`
              <div class="row input-row">
                ...
                >
                  ${m.options.map(tt=>g`
                    <option
                      .value=${tt}
                      ?selected=${this.optionEquals(tt,w)}
                    >${tt}</option>
                  `)}
                </select>
              </div>
            `})}
          ${N?this.renderLayoutPreview(N):u}
          ${f?D?u:g`<div class="row"><span class="label">Brightness</span><span class="value">${f.state}</span></div>`:u}
        </div>
      </ha-card>
    `}static styles=X`
    .header-row {
  ...
  `;renderLayoutPreview(t){let e=t.screenWidth,i=t.screenHeight,s=this.fitLayersToViewport(t.layers,e,i).sort((c,p)=>c.z-p.z),r="#000000",n="#4a4a4a",o="#d9d9d9",d="#808080",l="#ffffff",h=this.getLayerSourceLabelMap();return g`
      <div class="layout-preview">
        ...
        >
          ...
          ${s.map((c,p)=>{let y=this.resolveLayerSourceLabel(h,c.id,p)??c.source?.trim()??c.id,v=c.x+c.width/2,A=c.y+c.height/2,J=Math.min(c.width,c.height),Z=Math.max(54,e*.017),f=Math.max(J*.14,Z),F=Math.max(24,c.height*.38),$=Math.min(f,F),V=Math.max(18,$*.35),B=Math.max(32,c.width*.9),j=Math.max(1,Math.floor((B-V*2)/Math.max(1,$*.62))),D=y.length<=j?y:`${y.slice(0,Math.max(1,j-1))}\u2026`,P=D.length*$*.62,W=Math.min(B,P+V*2),N=Math.max(28,$*1.35),Q=v-W/2,m=A-N/2,w=Math.max(6,N*.25);return pt`
              <g>
                <rect
                  class="layout-layer"
                  x=${c.x}
