var et=globalThis,it=et.ShadowRoot&&(et.ShadyCSS===void 0||et.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,lt=Symbol(),It=new WeakMap,F=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==lt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(it&&t===void 0){let i=e!==void 0&&e.length===1;i&&(t=It.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&It.set(e,t))}return t}toString(){return this.cssText}},Pt=o=>new F(typeof o=="string"?o:o+"",void 0,lt),st=(o,...t)=>{let e=o.length===1?o[0]:t.reduce((i,s,r)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+o[r+1],o[0]);return new F(e,o,lt)},Rt=(o,t)=>{if(it)o.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let i=document.createElement("style"),s=et.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=e.cssText,o.appendChild(i)}},ht=it?o=>o:o=>o instanceof CSSStyleSheet?(t=>{let e="";for(let i of t.cssRules)e+=i.cssText;return Pt(e)})(o):o;var{is:ee,defineProperty:ie,getOwnPropertyDescriptor:se,getOwnPropertyNames:re,getOwnPropertySymbols:ne,getPrototypeOf:oe}=Object,rt=globalThis,Dt=rt.trustedTypes,ae=Dt?Dt.emptyScript:"",ce=rt.reactiveElementPolyfillSupport,V=(o,t)=>o,ut={toAttribute(o,t){switch(t){case Boolean:o=o?ae:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,t){let e=o;switch(t){case Boolean:e=o!==null;break;case Number:e=o===null?null:Number(o);break;case Object:case Array:try{e=JSON.parse(o)}catch{e=null}}return e}},Ot=(o,t)=>!ee(o,t),Mt={attribute:!0,type:String,converter:ut,reflect:!1,useDefault:!1,hasChanged:Ot};Symbol.metadata??=Symbol("metadata"),rt.litPropertyMetadata??=new WeakMap;var _=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=Mt){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(t,i,e);s!==void 0&&ie(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){let{get:s,set:r}=se(this.prototype,t)??{get(){return this[e]},set(n){this[e]=n}};return{get:s,set(n){let a=s?.call(this);r?.call(this,n),this.requestUpdate(t,a,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Mt}static _$Ei(){if(this.hasOwnProperty(V("elementProperties")))return;let t=oe(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(V("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(V("properties"))){let e=this.properties,i=[...re(e),...ne(e)];for(let s of i)this.createProperty(s,e[s])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[i,s]of e)this.elementProperties.set(i,s)}this._$Eh=new Map;for(let[e,i]of this.elementProperties){let s=this._$Eu(e,i);s!==void 0&&this._$Eh.set(s,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let i=new Set(t.flat(1/0).reverse());for(let s of i)e.unshift(ht(s))}else t!==void 0&&e.push(ht(t));return e}static _$Eu(t,e){let i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Rt(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){let i=this.constructor.elementProperties.get(t),s=this.constructor._$Eu(t,i);if(s!==void 0&&i.reflect===!0){let r=(i.converter?.toAttribute!==void 0?i.converter:ut).toAttribute(e,i.type);this._$Em=t,r==null?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(t,e){let i=this.constructor,s=i._$Eh.get(t);if(s!==void 0&&this._$Em!==s){let r=i.getPropertyOptions(s),n=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:ut;this._$Em=s;let a=n.fromAttribute(e,r.type);this[s]=a??this._$Ej?.get(s)??a,this._$Em=null}}requestUpdate(t,e,i,s=!1,r){if(t!==void 0){let n=this.constructor;if(s===!1&&(r=this[t]),i??=n.getPropertyOptions(t),!((i.hasChanged??Ot)(r,e)||i.useDefault&&i.reflect&&r===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,i))))return;this.C(t,e,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:s,wrapped:r},n){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),r!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),s===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,r]of this._$Ep)this[s]=r;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[s,r]of i){let{wrapped:n}=r,a=this[s];n!==!0||this._$AL.has(s)||a===void 0||this.C(s,void 0,r,a)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(e)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};_.elementStyles=[],_.shadowRootOptions={mode:"open"},_[V("elementProperties")]=new Map,_[V("finalized")]=new Map,ce?.({ReactiveElement:_}),(rt.reactiveElementVersions??=[]).push("2.1.2");var bt=globalThis,Ht=o=>o,nt=bt.trustedTypes,Tt=nt?nt.createPolicy("lit-html",{createHTML:o=>o}):void 0,jt="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,Wt="?"+E,de=`<${Wt}>`,k=document,W=()=>k.createComment(""),q=o=>o===null||typeof o!="object"&&typeof o!="function",$t=Array.isArray,le=o=>$t(o)||typeof o?.[Symbol.iterator]=="function",pt=`[ 	
\f\r]`,j=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Bt=/-->/g,Ut=/>/g,L=RegExp(`>|${pt}(?:([^\\s"'>=/]+)(${pt}*=${pt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),zt=/'/g,Ft=/"/g,qt=/^(?:script|style|textarea|title)$/i,_t=o=>(t,...e)=>({_$litType$:o,strings:t,values:e}),v=_t(1),K=_t(2),me=_t(3),N=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),Vt=new WeakMap,C=k.createTreeWalker(k,129);function Xt(o,t){if(!$t(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return Tt!==void 0?Tt.createHTML(t):t}var he=(o,t)=>{let e=o.length-1,i=[],s,r=t===2?"<svg>":t===3?"<math>":"",n=j;for(let a=0;a<e;a++){let c=o[a],d,p,l=-1,g=0;for(;g<c.length&&(n.lastIndex=g,p=n.exec(c),p!==null);)g=n.lastIndex,n===j?p[1]==="!--"?n=Bt:p[1]!==void 0?n=Ut:p[2]!==void 0?(qt.test(p[2])&&(s=RegExp("</"+p[2],"g")),n=L):p[3]!==void 0&&(n=L):n===L?p[0]===">"?(n=s??j,l=-1):p[1]===void 0?l=-2:(l=n.lastIndex-p[2].length,d=p[1],n=p[3]===void 0?L:p[3]==='"'?Ft:zt):n===Ft||n===zt?n=L:n===Bt||n===Ut?n=j:(n=L,s=void 0);let f=n===L&&o[a+1].startsWith("/>")?" ":"";r+=n===j?c+de:l>=0?(i.push(d),c.slice(0,l)+jt+c.slice(l)+E+f):c+E+(l===-2?a:f)}return[Xt(o,r+(o[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]},X=class o{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let r=0,n=0,a=t.length-1,c=this.parts,[d,p]=he(t,e);if(this.el=o.createElement(d,i),C.currentNode=this.el.content,e===2||e===3){let l=this.el.content.firstChild;l.replaceWith(...l.childNodes)}for(;(s=C.nextNode())!==null&&c.length<a;){if(s.nodeType===1){if(s.hasAttributes())for(let l of s.getAttributeNames())if(l.endsWith(jt)){let g=p[n++],f=s.getAttribute(l).split(E),b=/([.?@])?(.*)/.exec(g);c.push({type:1,index:r,name:b[2],strings:f,ctor:b[1]==="."?gt:b[1]==="?"?ft:b[1]==="@"?vt:T}),s.removeAttribute(l)}else l.startsWith(E)&&(c.push({type:6,index:r}),s.removeAttribute(l));if(qt.test(s.tagName)){let l=s.textContent.split(E),g=l.length-1;if(g>0){s.textContent=nt?nt.emptyScript:"";for(let f=0;f<g;f++)s.append(l[f],W()),C.nextNode(),c.push({type:2,index:++r});s.append(l[g],W())}}}else if(s.nodeType===8)if(s.data===Wt)c.push({type:2,index:r});else{let l=-1;for(;(l=s.data.indexOf(E,l+1))!==-1;)c.push({type:7,index:r}),l+=E.length-1}r++}}static createElement(t,e){let i=k.createElement("template");return i.innerHTML=t,i}};function H(o,t,e=o,i){if(t===N)return t;let s=i!==void 0?e._$Co?.[i]:e._$Cl,r=q(t)?void 0:t._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),r===void 0?s=void 0:(s=new r(o),s._$AT(o,e,i)),i!==void 0?(e._$Co??=[])[i]=s:e._$Cl=s),s!==void 0&&(t=H(o,s._$AS(o,t.values),s,i)),t}var yt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??k).importNode(e,!0);C.currentNode=s;let r=C.nextNode(),n=0,a=0,c=i[0];for(;c!==void 0;){if(n===c.index){let d;c.type===2?d=new Y(r,r.nextSibling,this,t):c.type===1?d=new c.ctor(r,c.name,c.strings,this,t):c.type===6&&(d=new mt(r,this,t)),this._$AV.push(d),c=i[++a]}n!==c?.index&&(r=C.nextNode(),n++)}return C.currentNode=k,s}p(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},Y=class o{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=H(this,t,e),q(t)?t===u||t==null||t===""?(this._$AH!==u&&this._$AR(),this._$AH=u):t!==this._$AH&&t!==N&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):le(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==u&&q(this._$AH)?this._$AA.nextSibling.data=t:this.T(k.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:i}=t,s=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=X.createElement(Xt(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{let r=new yt(s,this),n=r.u(this.options);r.p(e),this.T(n),this._$AH=r}}_$AC(t){let e=Vt.get(t.strings);return e===void 0&&Vt.set(t.strings,e=new X(t)),e}k(t){$t(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,s=0;for(let r of t)s===e.length?e.push(i=new o(this.O(W()),this.O(W()),this,this.options)):i=e[s],i._$AI(r),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let i=Ht(t).nextSibling;Ht(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},T=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,r){this.type=1,this._$AH=u,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=u}_$AI(t,e=this,i,s){let r=this.strings,n=!1;if(r===void 0)t=H(this,t,e,0),n=!q(t)||t!==this._$AH&&t!==N,n&&(this._$AH=t);else{let a=t,c,d;for(t=r[0],c=0;c<r.length-1;c++)d=H(this,a[i+c],e,c),d===N&&(d=this._$AH[c]),n||=!q(d)||d!==this._$AH[c],d===u?t=u:t!==u&&(t+=(d??"")+r[c+1]),this._$AH[c]=d}n&&!s&&this.j(t)}j(t){t===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},gt=class extends T{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===u?void 0:t}},ft=class extends T{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==u)}},vt=class extends T{constructor(t,e,i,s,r){super(t,e,i,s,r),this.type=5}_$AI(t,e=this){if((t=H(this,t,e,0)??u)===N)return;let i=this._$AH,s=t===u&&i!==u||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==u&&(i===u||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},mt=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){H(this,t)}};var ue=bt.litHtmlPolyfillSupport;ue?.(X,Y),(bt.litHtmlVersions??=[]).push("3.3.2");var Yt=(o,t,e)=>{let i=e?.renderBefore??t,s=i._$litPart$;if(s===void 0){let r=e?.renderBefore??null;i._$litPart$=s=new Y(t.insertBefore(W(),r),r,void 0,e??{})}return s._$AI(o),s};var wt=globalThis,w=class extends _{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Yt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return N}};w._$litElement$=!0,w.finalized=!0,wt.litElementHydrateSupport?.({LitElement:w});var pe=wt.litElementPolyfillSupport;pe?.({LitElement:w});(wt.litElementVersions??=[]).push("4.2.2");var St=class extends w{static LAYOUT_BUILD_MARKER="v0.2.33";_hass;config;optimisticPowerState;resolvedEntities={};resolvedLayerSourceEntities=[];resolvedDeviceId;resolvingDeviceId;resolvedForHass;lastRelevantStateSignature="";activeLayerSourceChooser;static properties={hass:{attribute:!1,noAccessor:!0},config:{attribute:!1}};get hass(){return this._hass}set hass(t){let e=this._hass;this._hass=t;let i=this.buildRelevantStateSignature(t),s=i!==this.lastRelevantStateSignature;this.lastRelevantStateSignature=i,(e!==t||s)&&this.requestUpdate("hass",e)}setConfig(t){let e={...t};e.type||="custom:novastar-h-series-card",this.config=e}getCardSize(){return 3}static async getConfigElement(){return document.createElement("novastar-h-series-card-editor")}static getStubConfig(){return{type:"custom:novastar-h-series-card",title:"Novastar H Series"}}updated(){this.ensureResolvedEntities(),this.syncOptimisticPowerState()}render(){if(!this.config)return v`<ha-card><div class="content">Invalid card configuration.</div></ha-card>`;if(!this.hass)return v`<ha-card><div class="content">Home Assistant context is unavailable.</div></ha-card>`;let t=this.getEntityId("controller_entity");if(!t){let R=this.config.device_id&&this.resolvingDeviceId===this.config.device_id?"Resolving entities for selected device...":"Set a device_id or controller_entity in card configuration.";return v`<ha-card><div class="content">${R}</div></ha-card>`}let e=this.hass.states[t];if(!e)return v`<ha-card><div class="content">Entity not found: ${t}</div></ha-card>`;let i=this.getEntityId("power_entity")??"switch.novastar_h2_power_screen_output",s=this.getEntityId("preset_entity"),r=this.getEntityId("screens_entity"),n=this.getEntityId("layers_entity"),a=this.getEntityId("status_entity"),c=this.getEntityId("brightness_entity"),d=this.getEntityId("temperature_entity"),p=this.hass.states[i],g=(this.optimisticPowerState??p?.state)==="on",f=!!p&&!g,b=a?this.hass.states[a]:void 0,x=s?this.hass.states[s]:void 0,y=r?this.hass.states[r]:void 0,I=n?this.hass.states[n]:void 0,m=c?this.hass.states[c]:void 0,P=d?this.hass.states[d]:void 0,B=m?Number.parseFloat(m.state):Number.NaN,G=m?this.readNumberAttribute(m,"min",0):0,J=m?this.readNumberAttribute(m,"max",100):100,ot=m?this.readNumberAttribute(m,"step",1):1,Q=m&&Number.isFinite(B),U=this.readStringListAttribute(x,"options"),S=this.readLayoutPayload(y,I),Z=b?`${e.state} (${b.state})`:e.state;return v`
      <ha-card>
        ...
        <div class="content">
          ...
          ${P?v`<div class="row"><span class="label">Temperature</span><span class="value">${P.state}</span></div>`:u}
          ${x?U.length>0?(()=>{let R=this.resolveSelectedOption(x,U);return v`
                    <div class="row input-row">
                      ...
                      >
                        ${U.map(D=>v`
                          <option
                            .value=${D}
                            ?selected=${this.optionEquals(D,R)}
                          >${D}</option>
                        `)}
                      </select>
                    </div>
                  `})():v`<div class="row"><span class="label">Preset</span><span class="value">${x.state}</span></div>`:u}
          ${S?this.renderLayoutPreview(S):u}
          ${m?Q?u:v`<div class="row"><span class="label">Brightness</span><span class="value">${m.state}</span></div>`:u}
        </div>
      </ha-card>
    `}static styles=st`
    .header-row {
  ...
  `;renderLayoutPreview(t){let e=t.screenWidth,i=t.screenHeight,s=this.fitLayersToViewport(t.layers,e,i).sort((y,I)=>y.z-I.z),r="#000000",n="#4a4a4a",a="#d9d9d9",c="#808080",d="#ffffff",p=this.getLayerSourceRows(),l=this.getLayerSourceLabelMap(),g=this.getEntityId("power_entity")??"switch.novastar_h2_power_screen_output",f=this.hass?.states[g],b=this.optimisticPowerState??f?.state,x=!!f&&b!=="on";return v`
      <div class="layout-preview">
        ...
        >
          ...
          ></rect>
          ${s.length===0?K`<text class="layout-empty" x=${e/2} y=${i/2}>No layers detected</text>`:u}
          ${s.map((y,I)=>{let m=this.resolveLayerSourceRow(p,y.id,I),P=this.resolveLayerSourceLabel(l,y.id,I)??y.source?.trim()??y.id,B=y.x+y.width/2,G=y.y+y.height/2,J=Math.min(y.width,y.height),ot=Math.max(54,e*.017),Q=Math.max(J*.14,ot),U=Math.max(24,y.height*.38),S=Math.min(Q,U),Z=Math.max(18,S*.35),R=Math.max(32,y.width*.9),D=Math.max(1,Math.floor((R-Z*2)/Math.max(1,S*.62))),xt=P.length<=D?P:`${P.slice(0,Math.max(1,D-1))}\u2026`,Kt=xt.length*S*.62,At=Math.min(R,Kt+Z*2),at=Math.max(28,S*1.35),Gt=B-At/2,Jt=G-at/2,Lt=Math.max(6,at*.25),h=Math.max(51,Math.min(138,J*.27)),Ct=Math.max(10,h*.22),A=Math.max(y.x+4,y.x+y.width-h-Ct),$=Math.min(y.y+Ct,y.y+y.height-h-4),ct=A+h*.22,Qt=$+h*.34,dt=h*.18,Zt=h*.32,te=[`${ct+dt},${$+h*.26}`,`${A+h*.68},${$+h*.16}`,`${A+h*.68},${$+h*.84}`,`${ct+dt},${$+h*.74}`].join(" "),M=A+h*.7,O=$+h*.5,kt=y.audioOpen===!0,Nt=y.audioOpen===!1,z=kt?"#66bb6a":Nt?"#858585":"#bdbdbd",tt=!!m&&!x;return K`
              <g>
                <rect
                  class="layout-layer"
                  x=${y.x}
                ...
                <g>
                  ...
                  <rect
                    ...
                    fill=${z}
                  ></rect>
                  <polygon points=${te} fill=${z}></polygon>
                  ${kt?K`
                      <path
                ...
                <rect
                  ...
                  fill="#111111"
                  fill-opacity="0.82"
                  @click=${tt?()=>this.openLayerSourceChooser(m):u}
                ></rect>
                <text
                  class=${tt?"layout-layer-hitbox":""}
                  x=${B}
                  y=${G}
                  font-weight="700"
                  style=${`fill:${d};font-size:${S}px;font-family:inherit;`}
                  text-anchor="middle"
                  dominant-baseline="middle"
                  @click=${tt?()=>this.openLayerSourceChooser(m):u}
                >${xt}</text>
        ...
        ${this.activeLayerSourceChooser?this.renderLayerSourceChooser(x):u}
      </div>
    `}getLayerSourceLabelMap(){let t=new Map;for(let e of this.getLayerSourceRows()){let i=this.resolveSelectedOption(e.entity,e.options).trim();i&&t.set(e.layerNumber,i)}return t}resolveLayerSourceLabel(t,e,i){let s=[],r=Number.parseInt(e,10);Number.isFinite(r)&&(s.push(r),s.push(r+1)),s.push(i),s.push(i+1);for(let n of s){let a=t.get(n)?.trim();if(a)return a}}resolveLayerSourceRow(t,e,i){let s=[],r=Number.parseInt(e,10);Number.isFinite(r)&&(s.push(r),s.push(r+1)),s.push(i),s.push(i+1);for(let n of s){let a=t.find(c=>c.layerNumber===n);if(a)return a}return t[i]}renderLayerSourceChooser(t){let e=this.activeLayerSourceChooser;return e?v`
  ...
  `};try{customElements.define("novastar-h-series-card",St)}catch{}try{customElements.define("novastar-h-series-card-editor",Et)}catch{}window.customCards=window.customCards||[];window.customCards.push({type:"novastar-h-series-card",name:"Novastar H Series Card",description:"Displays core status information for a Novastar H Series controller from device or entity config."});export{St as NovastarHSeriesCard};
