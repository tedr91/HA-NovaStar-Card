...
\f\r"'\`<>=]|("|')|))|$)`,"g"),We=/'/g,qe=/"/g,Ge=/^(?:script|style|textarea|title)$/i,Le=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),v=Le(1),ie=Le(2),bt=Le(3),D=Symbol.for("lit-noChange"),l=Symbol.for("lit-nothing"),Ye=new WeakMap,M=P.createTreeWalker(P,129);function Je(a,e){if(!ke(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ve!==void 0?Ve.createHTML(e):e}var ut=(a,e)=>{let t=a.length-1,i=[],s,r=e===2?"<svg>":e===3?"<math>":"",n=J;for(let o=0;o<t;o++){let c=a[o],d,p,u=-1,y=0;for(;y<c.length&&(n.lastIndex=y,p=n.exec(c),p!==null);)y=n.lastIndex,n===J?p[1]==="!--"?n=Fe:p[1]!==void 0?n=je:p[2]!==void 0?(Ge.test(p[2])&&(s=RegExp("</"+p[2],"g")),n=I):p[3]!==void 0&&(n=I):n===I?p[0]===">"?(n=s??J,u=-1):p[1]===void 0?u=-2:(u=n.lastIndex-p[2].length,d=p[1],n=p[3]===void 0?I:p[3]==='"'?qe:We):n===qe||n===We?n=I:n===Fe||n===je?n=J:(n=I,s=void 0);let f=n===I&&a[o+1].startsWith("/>")?" ":"";r+=n===J?c+lt:u>=0?(i.push(d),c.slice(0,u)+Ke+c.slice(u)+A+f):c+A+(u===-2?o:f)}return[Je(a,r+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},ee=class a{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let r=0,n=0,o=e.length-1,c=this.parts,[d,p]=ut(e,t);if(this.el=a.createElement(d,i),M.currentNode=this.el.content,t===2||t===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(s=M.nextNode())!==null&&c.length<o;){if(s.nodeType===1){if(s.hasAttributes())for(let u of s.getAttributeNames())if(u.endsWith(Ke)){let y=p[n++],f=s.getAttribute(u).split(A),b=/([.?@])?(.*)/.exec(y);c.push({type:1,index:r,name:b[2],strings:f,ctor:b[1]==="."?xe:b[1]==="?"?Se:b[1]==="@"?Ee:U}),s.removeAttribute(u)}else u.startsWith(A)&&(c.push({type:6,index:r}),s.removeAttribute(u));if(Ge.test(s.tagName)){let u=s.textContent.split(A),y=u.length-1;if(y>0){s.textContent=ve?ve.emptyScript:"";for(let f=0;f<y;f++)s.append(u[f],Q()),M.nextNode(),c.push({type:2,index:++r});s.append(u[y],Q())}}}else if(s.nodeType===8)if(s.data===Xe)c.push({type:2,index:r});else{let u=-1;for(;(u=s.data.indexOf(A,u+1))!==-1;)c.push({type:7,index:r}),u+=A.length-1}r++}}static createElement(e,t){let i=P.createElement("template");return i.innerHTML=e,i}};function T(a,e,t=a,i){if(e===D)return e;let s=i!==void 0?t._$Co?.[i]:t._$Cl,r=Z(e)?void 0:e._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),r===void 0?s=void 0:(s=new r(a),s._$AT(a,t,i)),i!==void 0?(t._$Co??=[])[i]=s:t._$Cl=s),s!==void 0&&(e=T(a,s._$AS(a,e.values),s,i)),e}var we=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??P).importNode(t,!0);M.currentNode=s;let r=M.nextNode(),n=0,o=0,c=i[0];for(;c!==void 0;){if(n===c.index){let d;c.type===2?d=new te(r,r.nextSibling,this,e):c.type===1?d=new c.ctor(r,c.name,c.strings,this,e):c.type===6&&(d=new Ae(r,this,e)),this._$AV.push(d),c=i[++o]}n!==c?.index&&(r=M.nextNode(),n++)}return M.currentNode=P,s}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},te=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=l,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=T(this,e,t),Z(e)?e===l||e==null||e===""?(this._$AH!==l&&this._$AR(),this._$AH=l):e!==this._$AH&&e!==D&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ht(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==l&&Z(this._$AH)?this._$AA.nextSibling.data=e:this.T(P.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=ee.createElement(Je(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{let r=new we(s,this),n=r.u(this.options);r.p(t),this.T(n),this._$AH=r}}_$AC(e){let t=Ye.get(e.strings);return t===void 0&&Ye.set(e.strings,t=new ee(e)),t}k(e){ke(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,s=0;for(let r of e)s===t.length?t.push(i=new a(this.O(Q()),this.O(Q()),this,this.options)):i=t[s],i._$AI(r),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=Ue(e).nextSibling;Ue(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},U=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,r){this.type=1,this._$AH=l,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=l}_$AI(e,t=this,i,s){let r=this.strings,n=!1;if(r===void 0)e=T(this,e,t,0),n=!Z(e)||e!==this._$AH&&e!==D,n&&(this._$AH=e);else{let o=e,c,d;for(e=r[0],c=0;c<r.length-1;c++)d=T(this,o[i+c],t,c),d===D&&(d=this._$AH[c]),n||=!Z(d)||d!==this._$AH[c],d===l?e=l:e!==l&&(e+=(d??"")+r[c+1]),this._$AH[c]=d}n&&!s&&this.j(e)}j(e){e===l?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},xe=class extends U{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===l?void 0:e}},Se=class extends U{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==l)}},Ee=class extends U{constructor(e,t,i,s,r){super(e,t,i,s,r),this.type=5}_$AI(e,t=this){if((e=T(this,e,t,0)??l)===D)return;let i=this._$AH,s=e===l&&i!==l||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==l&&(i===l||s);s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ae=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}};var pt=Ce.litHtmlPolyfillSupport;pt?.(ee,te),(Ce.litHtmlVersions??=[]).push("3.3.2");var Qe=(a,e,t)=>{let i=t?.renderBefore??e,s=i._$litPart$;if(s===void 0){let r=t?.renderBefore??null;i._$litPart$=s=new te(e.insertBefore(Q(),r),r,void 0,t??{})}return s._$AI(a),s};var Ne=globalThis,w=class extends _{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Qe(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return D}};w._$litElement$=!0,w.finalized=!0,Ne.litElementHydrateSupport?.({LitElement:w});var vt=Ne.litElementPolyfillSupport;vt?.({LitElement:w});(Ne.litElementVersions??=[]).push("4.2.2");var Ie=class a extends w{static LAYOUT_BUILD_MARKER="v1.0.6-1-gfb02fc5-dirty";_hass;config;optimisticPowerState;resolvedEntities={};resolvedLayerSourceEntities=[];resolvedDeviceId;resolvingDeviceId;resolvedForHass;lastRelevantStateSignature="";activeLayerSourceChooser;static properties={hass:{attribute:!1,noAccessor:!0},config:{attribute:!1}};get hass(){return this._hass}set hass(e){let t=this._hass;this._hass=e;let i=this.buildRelevantStateSignature(e),s=i!==this.lastRelevantStateSignature;this.lastRelevantStateSignature=i,(t!==e||s)&&this.requestUpdate("hass",t)}setConfig(e){let t={...e};t.type||="custom:novastar-h-series-card",this.config=t}getCardSize(){return 3}static async getConfigElement(){return document.createElement("novastar-h-series-card-editor")}static getStubConfig(){return{type:"custom:novastar-h-series-card",header:"Novastar H Series"}}updated(){this.ensureResolvedEntities(),this.syncOptimisticPowerState()}render(){if(!this.config)return v`<ha-card><div class="content">Invalid card configuration.</div></ha-card>`;if(!this.hass)return v`<ha-card><div class="content">Home Assistant context is unavailable.</div></ha-card>`;let e=this.getEntityId("controller_entity");if(!e){let ce=this.config.device_id&&this.resolvingDeviceId===this.config.device_id?"Resolving entities for selected device...":"Set a device_id or controller_entity in card configuration.";return v`<ha-card><div class="content">${ce}</div></ha-card>`}let t=this.hass.states[e];if(!t)return v`<ha-card><div class="content">Entity not found: ${e}</div></ha-card>`;let i=this.getEntityId("power_entity")??"switch.novastar_h2_power_screen_output",s=this.getEntityId("preset_entity"),r=this.getEntityId("screens_entity"),n=this.getEntityId("layers_entity"),o=this.getEntityId("status_entity"),c=this.getEntityId("brightness_entity"),d=this.getEntityId("temperature_entity"),p=this.hass.states[i],y=(this.optimisticPowerState??p?.state)==="on",f=!!p&&!y,b=o?this.hass.states[o]:void 0,x=s?this.hass.states[s]:void 0,se=r?this.hass.states[r]:void 0,g=n?this.hass.states[n]:void 0,m=c?this.hass.states[c]:void 0,S=d?this.hass.states[d]:void 0,C=m?Number.parseFloat(m.state):Number.NaN,V=m?this.readNumberAttribute(m,"min",0):0,F=m?this.readNumberAttribute(m,"max",100):100,j=m?this.readNumberAttribute(m,"step",1):1,re=!!m&&Number.isFinite(C),W=m?this.readStringAttribute(m,"unit_of_measurement")??"":"",k=this.readStringListAttribute(x,"options"),E=x?this.resolveSelectedOption(x,k):"",q=this.readLayoutPayload(se,g),Y=b?`${t.state} (${b.state})`:t.state,ne=S?this.readStringAttribute(S,"unit_of_measurement")??"":"",L=this.getDisplayMode(),R=L==="compact",O=L==="detailed",H=this.config.show_header_in_compact===!0,ge=!R||H,ae=R&&!H,oe=this.config.header??"Novastar H Series",h=["content",`content--${L}`,ae?"content--bare":""].filter(Boolean).join(" ");return v`
          ...
          ${R?l:O?v`
                  ...
                  ${x?v`
                        <div class="row input-row preset-row">
                          ...
                          ${k.length>0?this.renderPresetChips(k,E,f):v`<span class="value">${x.state}</span>`}
                        </div>
                      `:l}
                `:v`
                  ${re?v`<div class="standard-block">${this.renderBrightnessControl(V,F,j,C,f,W)}</div>`:l}
                  ${x&&k.length>0?v`<div class="standard-block standard-block--chips">${this.renderPresetChips(k,E,f)}</div>`:l}
                `}
          ${q?this.renderLayoutPreview(q,ae):R?v`<div class="row"><span class="label">Layout</span><span class="value">Unavailable</span></div>`:l}
    ...
    `}renderVersionFooter(){return v`<div class="version-footer">${a.LAYOUT_BUILD_MARKER}</div>`}static styles=ue`
    :host {
  ...
  `;renderLayoutPreview(e,t=!1){let i=e.screenWidth,s=e.screenHeight,r=this.fitLayersToViewport(e.layers,i,s).sort((g,m)=>g.z-m.z),n="#000000",o="#4a4a4a",c="#d9d9d9",d="#808080",p="#ffffff",u=this.getLayerSourceRows(),y=this.getLayerSourceLabelMap(),f=this.getEntityId("power_entity")??"switch.novastar_h2_power_screen_output",b=this.hass?.states[f],x=this.optimisticPowerState??b?.state,se=!!b&&x!=="on";return v`
