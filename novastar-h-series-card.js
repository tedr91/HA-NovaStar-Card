        ...
        <div class="content">
          ...
          ${v?it.length>0?u`
                  <div class="row input-row">
                    ...
                    >
                      ${it.map(y=>u`<option .value=${y}>${y}</option>`)}
                    </select>
                  </div>
          ...
          `)}
          ${g?st?l:u`<div class="row"><span class="label">Brightness</span><span class="value">${g.state}</span></div>`:l}
        </div>
      </ha-card>
    `}static styles=O`
    .header-row {
